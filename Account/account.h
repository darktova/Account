...
static const char* menu =
	...
	"\n\n\'C\' = Create new account here"
	"\n\n\'L\' = Load account from default file (account.txt)"
	"\n\n\'R\' = Load account from custom file"
	"\n\n\'S\' = Save account to default file (account.txt)"
	"\n\n\'W\' = Save account to custom file"
	"\n\n\'F\' = Set new I/O file name"
	"\n\n\'D\' = Display account data"
	"\n\n\nCURRENT USER ID: "
	"\t";
...
private:
	...
	// set the file name from user input (account.txt, so on).
	void SetNewFileName();
